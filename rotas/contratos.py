...
<p><strong>4.1.2.</strong> Nos primeiros 24 (vinte e cinco) dias, o <strong>LOCATARIO</strong> pagara R$ 25,00 (vinte e cinco reais) a mais no valor diario ou no semanal usando este valor diario como base a titulo de caucao e cadastro. Este valor ficara retido ate o final do contrato sendo 40% a titulo de taxa de cadastro, cujo nao sera devolvido e 60% a tao titulo de caucao que sera usado ao termino do contrato para abatimento de despesas como limpeza ou possiveis danos ao veiculo e caso nao haja nenhum destes fatores, sera abatido nas ultimas diarias do <strong>LOCATARIO</strong>.</p>
