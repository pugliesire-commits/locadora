...
from rotas import veiculos, clientes, locacoes, auth, pagamentos, financiamento, despesas, indicadores, investidores, parcelas, relatorio
...
from modelos import despesa, investidor, lancamento, parcela
